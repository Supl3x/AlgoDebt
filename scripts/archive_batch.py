...
def main():
    ...
    # Also move any model processing folders generated by the interactive pipeline
    processing_folders = glob.glob(os.path.join(results_dir, "*_processing"))
    for folder in processing_folders:
        folder_name = os.path.basename(folder)
        shutil.move(folder, os.path.join(new_batch_dir, folder_name))
